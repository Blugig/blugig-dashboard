...
import {
    ...
    LineChart, LogOut, NotepadText, UserCog2, Users
} from 'lucide-react';
...
export default function SideBar() {
    ...
    return (
        <aside
            className={cn(
                "min-w-[18%] border-r border-slate-300 bg-white h-screen -translate-x-full lg:translate-x-0 transition-[width] ease-in-out duration-300",
                // sidebar.isOpen ? "min-w-[18%]" : "w-[0]"
            )}
        >
                ...
                <ScrollArea className="w-full flex-1" orientation="vertical">
                    <nav className="grid items-start px-2 text-sm font-medium lg:px-4">
                        {sideBarRoutes.map((route, i) => {
                            ...
                            // const filteredSubRoutes = route.routes;
